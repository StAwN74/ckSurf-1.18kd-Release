...
[More info...]
Quote from the script of the 'no discord' version:
...
// Discord api is not implemented yet, for now. 'Force CT team' was intentionally removed, as well as server cvars management. Use maps configs instead.
