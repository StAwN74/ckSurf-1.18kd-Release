...
//bool GameStartBool;												// Fixing bot_quota change and bot name change at GameStart (mp_restartgame or 1st bot joining AFTER a lonely player made a record)
...
#include "ckSurf/misc_name_finalh.sp"
#include "ckSurf/admin.sp"
#include "ckSurf/commands_rev.sp"
#include "ckSurf/hooks_final3_colors_buy_rev.sp"
#include "ckSurf/buttonpress.sp"
#include "ckSurf/sql_rev.sp"
#include "ckSurf/timer_final_rev.sp"
#include "ckSurf/replay_final5_fixed_rev.sp"
...
public void OnMapStart()
{
	...
	//GameStartBool = false;
	//Will be set to true when CSRoundEnd_GameStart is fired
	...
	if(WeAreOk || (StrContains(g_szMapName, "surf_", false) != -1) || (StrContains(g_szMapName, "bhop_", false) != -1) || (StrContains(g_szMapName, "xc_", false) != -1) || (StrContains(g_szMapName, "kz_", false) != -1) || (StrContains(g_szMapName, "bkz_", false) != -1))
	{
		...
		//You need this on surf_summer, surf_guitar etc
...
public void OnPluginStart()
{
	...
	HookEvent("round_freeze_end", Event_OnFreezeEnd, EventHookMode_Pre);
