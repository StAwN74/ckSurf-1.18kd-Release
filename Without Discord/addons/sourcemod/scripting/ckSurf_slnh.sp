...
#include "ckSurf/hooks_final3_colors_buy.sp"
#include "ckSurf/buttonpress.sp"
#include "ckSurf/sql.sp"
#include "ckSurf/timer_final.sp"
#include "ckSurf/replay_final5_fixed.sp"
...
public void OnPluginStart()
{
	...
	g_hAutoRespawn = CreateConVar("ck_autorespawn", "1", "on/off - Auto respawn (depreciated, forced on via map configs)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
