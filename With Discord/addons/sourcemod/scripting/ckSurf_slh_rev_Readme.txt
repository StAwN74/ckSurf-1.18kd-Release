...
So, if you use disabled/ckSurf_slh.smx, you HAVE to set sv_hibernate_when_empty 0 in your launch command and in your server.cfg. Otherwise, your database WILL SURELY be corrupt.
 ***
