# ckSurf-1.18kd-Release 🌍
  ...
  Available for any server tickrate. Only 1 replay and 1 bonus bot (the fastest one) for maps with several bonuses, to finally break completely this memory leak.  
