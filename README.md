...
Thanks to ZZK community and Freak.exe for testing, and support.  
...
# Changelog
  ...
  - 16/01/20: Fixed weapons buy on regular maps like de_dust2,  and 'checkSpawns' log error. Plugin uses maps configs (cfg/sourcemod/ckSurf/map_types/) for respawn and round end. ck_autorespawn and ck_round_end are thus obsolete.  
