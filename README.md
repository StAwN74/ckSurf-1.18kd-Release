...
# Changelog:
  - 16/01/20: ck_surf sl, slh, sln, slnh .sp & .smx updated (8 files) and also scripting/cksurf/misc and hooks .sp (6 files).
    ...
    - > A second log error has recently been reported (at RecordReplay callback when all velocities are null, i.e idle player). If it was due to the error above, it is now fixed. Otherwise, see To Do part below.
