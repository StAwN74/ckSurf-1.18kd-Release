...
# Changelog
  ...
  Discovered you should not try mp_restartgame on surf_summer -_- (Plugin blocks restart but this map triggers a 2d one)  
  Currently importing [url=https://forums.alliedmods.net/showthread.php?p=2004356]this code[/url] from htcarnage.
